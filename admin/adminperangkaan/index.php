...
defined( '_UMPORTAL_ADMIN' ) or die( 'Akses tidak dibenarkan !' );
 ...
 global $username;
    ...
    $id=$_GET["id"];
	$query = "SELECT title,createddate,content,active FROM perangkaan where id=1 ";
 ...
 ?>
<form name="frmrole" method="post" action="admin.php?module=adminperangkaan&task=simpan">
<table id="form_table_outer" width="90%">
  <tr><td class="form_table_header">Kemaskini Perangkaan</td></tr>
  <tr><td>
