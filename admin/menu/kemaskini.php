...
<table id="form_table_outer" width="60%">
  <tr><td class="form_table_header">Kemaskini Menu Pengguna</td></tr>
  <tr><td>
<table id="form_table_inner" width="100%" border="0" bgcolor="#EEF3FF" cellpadding="2" cellspacing="0">
    ...
    <tr> 
	  ...
	  if ($jenis<>"menu"){
	    ...
	    $query = "SELECT id,title FROM menu where type='menu' and admin='0' ";
        $result = sql_query($query,$dbi);
	    $num_rows = sql_num_rows($result);
	  ...
	  if ($jenis=="maklumat"){
	   ...
	   if($num_rows > 0) {
        ...
        echo "</select></td></tr>";
		 ...
		 if ($jenis<>"menu") 
	        echo "<tr><td>Pautan</td><td colspan=\"3\"><input name=\"txt_pautan\"  type=\"text\" size=\"80\" maxlength=\"80\" value=\"$pautan\"></td></tr>";
    ...
    <tr> 
	  ...
	  <?php
        ...
        if ($jenis=="menu")  
           $query = "SELECT menupos FROM menu where admin='0' and type='$jenis' order by menupos";
        else
	       $query = "SELECT menupos FROM menu where admin='0' and parent='$menu' order by menupos";
    ...
    <tr> 
      <td colspan="2" >
		...
		<input name="Kembali" type="Button" value="Kembali" onclick="location.href='admin.php?module=menu';"> 
      </td>
    </tr>
  </table></td></tr></table>
</form>
