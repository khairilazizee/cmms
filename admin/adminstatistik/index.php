...
defined( '_UMPORTAL_ADMIN' ) or die( 'Akses tidak dibenarkan !' );
 ...
 global $username;
    ...
    $id=$_GET["id"];
	$query = "SELECT title,createddate,content,active FROM statistik where id=1 ";
 ...
 ?>
<form name="frmrole" method="post" action="admin.php?module=adminstatistik&task=simpan">
<table id="form_table_outer" width="90%">
  <tr><td class="form_table_header">Kemaskini Statistik</td></tr>
  <tr><td>
