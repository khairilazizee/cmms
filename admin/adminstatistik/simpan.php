...
defined( '_UMPORTAL_ADMIN' ) or die( 'Akses tidak dibenarkan !' );
 ...
 global $dbi;
  ...
  if ($dbtrans=="0") //insert
     $qry="insert into statistik(author,title,createddate,content,active)
	       values('$author','$title','$now','$content','1')"; 
  else if ($dbtrans=="1") //update
     $qry="update statistik set author='$author',title='$title',content='$content',active='1'";
...
<?php  
  pageredirect("admin.php?module=adminstatistik");
