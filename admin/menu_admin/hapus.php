...
defined( '_UMPORTAL_ADMIN' ) or die( 'Akses tidak dibenarkan !' );
 ...
 function susun($menupos,$parent,$type)
 {
  ...
  global $dbi;
  if ($type=="menu")  
     $query = "SELECT id,menupos FROM menu where admin='1' and type='$type' and menupos > $menupos order by menupos";
  else
	 $query = "SELECT id,menupos FROM menu where admin='1' and parent='$parent' and menupos > $menupos order by menupos";
 ...
 header("Location: admin.php?module=menu_admin");
?> 
