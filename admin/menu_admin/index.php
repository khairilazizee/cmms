...
global $dbi;
  ...
  echo "<td>$menupos</td>";
  echo "<td>$aktif</td>";
  echo "<td><a href='admin.php?module=menu_admin&task=kemaskini&id=$parentid'><img src='images/admin/btn_edit.gif' border='0' alt='Kemaskini'></a>";
  if ($submenu==1 or ($submenu==0 and $cntsubmenu==0)) //papar butang hapus jika menu tiada submenu
     echo "&nbsp;&nbsp;<a href='admin.php?module=menu_admin&task=hapus&id=$parentid' onclick='return confirm(\"Hapuskan rekod ?\");'><img src='images/admin/btn_delete.gif' border='0' alt='Hapus'></a></td>";
...
<TR><TD class="list_table_pageheader">Menu Admin</TD></TR>
<tr><td>
<TABLE cellpadding="1" cellspacing="1" border="0" width="100%">
 		<tr><td colspan="4"><input type="button" name="Tambah" value="Tambah" onclick="location.href='admin.php?module=menu_admin&task=tambah';">
		&nbsp;<input type="button" value="Susun Semula" name="btnSusun" onClick="location.href='admin.php?module=menu_admin&task=susun';">
		</td></tr>

 <?

	$query = "SELECT id,title,type,active,menupos,admin FROM menu where type='menu' and admin='1' order by menupos ";
