...
<table class="table" align="center" width="100%" cellspacing="3" cellpadding="0">
    <tr>
        <td style="font-weight:bold;" colspan="12">Senarai Rutin</td>
    </tr>
    <tr>
        <th width="5">Bil</th>
    ...
    $sql = "SELECT id, sg_id, sys_id, tg_id, staff_id, ag_id, asset_id, hari, ws_id, catatan  FROM tbl_rutin WHERE 1";
    // if($staffid<>""){
    ...
    while($data = mysql_fetch_array($resfull)){
        ...
        $haridesc = GetDesc("tbl_hari","keterangan_bm","id",$hariid);
        ...
        // echo "<td>$pengadu</td>";
        echo "<td valign=\"top\" align=\"center\">Tugasan Rutin</td>";
        echo "<td valign=\"top\" align=\"center\">$jabatan</td>";
        // echo "<td align=\"center\">$kaedahdesc</td>";
        echo "<td valign=\"top\" align=\"center\">$haridesc</td>";
...
<div style="text-align:center;">
    <?php
    print $Mfunction->page("?module=Setup&task=view_rutin&displayframework=0", $limit, $rowstart, $numrows);
    ?>
</div>
