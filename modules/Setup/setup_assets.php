...
if($_POST['submit']){
    ...
    if($flg == "add"){
        $insert = "INSERT INTO asset (asset_desc) VALUES ('$taskdesc')";
        sql_query($insert,$dbi);
    } elseif($flg == "edit"){
        $update = "UPDATE asset SET asset_desc='$taskdesc' WHERE asset_id='$tid'";
        //die($update);
...
$flg = "add";
$check = "SELECT asset_desc, asset_id FROM asset WHERE asset_id='$tid'";
//echo $check;
