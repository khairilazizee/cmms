...
if($_POST['submit']){
	...
	// die();
	if($flg=="add"){
		$sqlworkorder = "INSERT INTO tbl_workorder (sg_id, tg_id, sys_id, staff_id, task_date, ag_id, asset_id,ws_id,js_id) VALUES ('$sysgroup','$kumptugasan','$system','$juruteknik','$tarikhmula','$asgroup','$asset','1','1')";
