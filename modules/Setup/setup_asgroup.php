<script type="text/javascript">
    function checkform(){
        if (document.frmtask.txtAssetDesc.value=="") {
            alert("Sila masukkan penerangan kumpulan aset.");
...
if($_POST['submit']){
    ...
    pageredirect("mainpage.php?module=Setup&task=list_asgroup");
...
<table width="100%" cellspacing="3" cellpadding="3" align="center" class="outerform">
    <tr>
        <td style="font-weight:bold;" class="formheader" colspan="3">Kumpulan Aset</td>
    </tr>
    <tr>
        <td width="220" valign="middle" class="title">Penerangan Kumpulan Aset</td>
    ...
    <tr>
        <td colspan="3">
            ...
            <input type="button" name="back" value="Kembali" onclick="location.href='mainpage.php?module=Setup&task=list_asgroup'" class="button"/>
        </td>
    </tr> 
</table>
</form>
