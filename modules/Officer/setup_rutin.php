...
if(isset($_POST['submit'])){
	...
	if($flg=="edit"){
		$update = "UPDATE tbl_rutin SET sg_id='$sysgroup', sys_id='$system', tg_id='$kumptugasan',staff_id='$juruteknik', hari='$hari', ag_id='$asgroup', asset_id='$asset', ws_id='$wstatus' WHERE id='$rutin'";
		mysql_query($update,$dbi);
	}
    // echo("You selected $N day(s): ");

    pageredirect("mainpage.php?module=Officer&task=list_rutin");
    
}

$flg = "add";
$sqlselect = "SELECT sg_id, sys_id, tg_id, staff_id, hari, ag_id, asset_id, ws_id FROM tbl_rutin WHERE id='$rutinid'";
...
<table class="outerform" width="100%" cellspacing="0" cellpadding="3" align="center">
	...
	<tr>
		<td colspan="3">
	        ...
	        <input type="button" name="back" value="Kembali" onclick="location.href='mainpage.php?module=Officer&task=list_rutin'" class="button"/>
	    </td>
    </tr>
</table>
</form>
