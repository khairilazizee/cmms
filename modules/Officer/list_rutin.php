...
<table width="100%">
	<tr>
		<td>
			<ul class="nav">
		    	<li><a class="<?php echo $ahad;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=7">Ahad</a></li>
		    	<li><a class="<?php echo $sabtu;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=6">Sabtu</a></li>
		    	<li><a class="<?php echo $jumaat;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=5">Jumaat</a></li>
		    	<li><a class="<?php echo $khamis;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=4">Khamis</a></li>
		    	<li><a class="<?php echo $rabu;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=3">Rabu</a></li>
		    	<li><a class="<?php echo $selasa;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=2">Selasa</a></li>
		    	<li><a class="<?php echo $isnin;?>" href="mainpage.php?module=Officer&task=list_rutin&hari=1">Isnin</a></li>
		    </ul>
		</td>
	</tr>
	<tr>
						...
						<?php
							...
							while($info = mysql_fetch_array($resrutinfull)){
								...
								echo "<td align='center'>
									 <a href=\"mainpage.php?module=Officer&task=setup_rutin&rutin=$idrutin\"><img src=\"images/admin/btn_edit.gif\"/></a></td>";
								// echo "<td align='center'>
