...
if($_POST['workorder']){
    ...
    pageredirect("mainpage.php?module=Engineer&task=workorder");
}
...
<table class="table" align="center" width="100%" cellspacing="3" cellpadding="0">
    <tr>
        <td style="font-weight:bold;" colspan="6">
            ...
            <div style="float: right";><input type="button" name="back" class="button" value="Kembali" onclick="history.go(-1);" /></div>
        </td>
    </tr>
    <tr>
        <th width="5">Bil</th>
    ...
    <!-- <tr>
        <td colspan="6">
            ...
            <input type="button" class="button" value="Kembali" name="kembali" onclick="location.href='mainpage.php?module=Engineer&task=workorder'"/>
        </td>
    </tr> -->
</table>
</form>
    ...
    <table class="table" align="center" width="100%" cellspacing="3" cellpadding="0">
        ...
        <tr>
            <td class="title" colspan="6">
                ...
                <textarea name="txtCatatanPemeriksaan" rows="10" cols="100"></textarea>
            </td>
        </tr>
        <tr>
        <td colspan="6">
            <input type="submit" class="button" value="Hantar" name="inspection"/>
            <input type="button" class="button" value="Kembali" name="kembali" onclick="history.go(-1);"/>
        </td>
    </tr>
    </table>
</form>
