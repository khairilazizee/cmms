...
<table width="100%">
	<tr>
		<td>
			<ul class="nav">
		    	<li><a class="<?php echo $ahad;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=7">Ahad</a></li>
		    	<li><a class="<?php echo $sabtu;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=6">Sabtu</a></li>
		    	<li><a class="<?php echo $jumaat;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=5">Jumaat</a></li>
		    	<li><a class="<?php echo $khamis;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=4">Khamis</a></li>
		    	<li><a class="<?php echo $rabu;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=3">Rabu</a></li>
		    	<li><a class="<?php echo $selasa;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=2">Selasa</a></li>
		    	<li><a class="<?php echo $isnin;?>" href="mainpage.php?module=Engineer&task=list_rutin&hari=1">Isnin</a></li>
		    </ul>
		</td>
	</tr>
	<tr>
			...
			<div class="ruang">
				<div id="isi">
					<table width="100%" cellspacing="1" cellpadding="4" align="center" class="table">
						...
						<?php
							$bil=0;
							$sqlrutin = "SELECT tbl_rutin.id, tbl_rutin.tg_id, tbl_rutin.staff_id, tbl_rutin.ag_id, tbl_rutin.ws_id, tbl_engineer_tg.tg_id FROM tbl_rutin, tbl_engineer_tg WHERE tbl_rutin.tg_id=tbl_engineer_tg.tg_id and tbl_rutin.hari='$haripilih' and tbl_rutin.js_id='3' and tbl_rutin.ws_id!='1'";
							if($staffagid<>0){
								$sqlrutin.=" and tbl_rutin.ag_id='$staffagid'";
							}
							// echo $sqlrutin;
							...
							while($info = mysql_fetch_array($resrutinfull)){
								...
								echo "<td align='center'>
									 <a href=\"mainpage.php?module=Engineer&task=setup_rutin&rutin=$idrutin\"><img src=\"images/admin/btn_edit.gif\"/></a></td>";
								// echo "<td align='center'>
