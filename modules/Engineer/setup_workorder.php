...
if($_POST['submit']){
	...
	pageredirect("mainpage.php?module=Engineer&task=list_workorder");
...
<table class="outerform" width="100%" cellspacing="0" cellpadding="3" align="center">
	...
	<tr>
		<td colspan="3">
	        ...
	        <input type="button" name="back" value="Kembali" onclick="location.href='mainpage.php?module=Engineer&task=list_workorder'" class="button"/>
	    </td>
    </tr>
</table>
</form>
